...
function crearCorazon() {
  // Colores variados
  const colores = ["#7dd3fc", "#c084fc", "#facc15", "#fb7185"];
...
let para = "Ale <3"; // valor por defecto
let mensaje = `Hoy quería cambiar la manera de decirte buenos días.
No con un mensaje corto, ni con una frase repetida… sino con algo que se parezca más a lo que siento al despertar y pensar en ti.

Porque hoy no es cualquier día. Hoy se cumple un mes desde que dijiste que sí, desde que lo que alguna vez fue solo un pensamiento se convirtió en una realidad que compartimos.

Un mes puede parecer poco, pero para mí ha sido suficiente para descubrir que los días contigo se sienten distintos: más ligeros, más llenos de vida, más míos y más tuyos a la vez.

En este tiempo me he dado cuenta de que contigo todo se transforma, las risas duran más, los silencios pesan menos, los planes se sienten más emocionantes. Y yo, sin darme cuenta, he ido aprendiendo que estar contigo es también otra forma de estar conmigo mismo, de ser alguien mejor.

Quizá todavía no tenga todas las palabras, ya lo sabes; siempre me faltan, pero sí tengo la certeza de algo: quiero seguir sumando meses, días y momentos contigo.

Gracias por este primer mes, Ale.
Gracias por hacer que mi presente tenga tu nombre, y que mi futuro también quiera tenerlo.
...
let mensajeAnim = {
  ...
  idx: 0,
  timer: null,
  velocidad: 80 // ms por letra (antes 28)
};
let loadingText = "Para Ale <3"; // valor por defecto para loading
...
function dibujarCarta() {
  ...
  if (carta.openProgress < 0.2) {
    ...
    ctx.font = "normal 1rem 'Dancing Script', cursive";
  ...
  */
  ...
  if (carta.openProgress > 0.7) {
    ...
    function getLines(fontSizeTry) {
      ctx.font = `bold ${fontSizeTry}px 'Dancing Script', cursive`;
